...
class Tank2(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load(os.path.join(os.path.dirname(os.path.abspath(__file__)),"Image/Tank2.png")).convert_alpha()
        ...
        self.rect.bottom = Settings.WINDOW.height - 11
